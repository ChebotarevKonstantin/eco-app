...
const props = {category:'styrofoam', material:'plastic'};
  ...
  return (
    ...
    <FindAdress props={props}/>
      ...
      <p4>Вот как действует пластик на различные сферы:
...
Пластмассы влияют на все живое, поэтому в мире стараются решить эту проблему, занимаясь переработкой мусора, очищая океан и разрабатывая программы, направленные на защиту окружающей среды.</p4>
    </div>
    </div>
